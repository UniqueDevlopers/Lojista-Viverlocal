        ...
        body: GetBuilder<OrderController>(builder: (orderController) {
          ...
          bool _restConfModel =
              Get.find<SplashController>().configModel.orderConfirmationModel !=
                  'deliveryman';
          bool _showSlider = _controllerOrderModer != null
              ? (_controllerOrderModer.orderStatus == 'pending' &&
                      (_controllerOrderModer.orderType == 'take_away' ||
                          _restConfModel ||
                          _selfDelivery)) ||
                  _controllerOrderModer.orderStatus == 'confirmed' ||
                  _controllerOrderModer.orderStatus == 'processing' ||
                  (_controllerOrderModer.orderStatus == 'accepted' &&
                      _controllerOrderModer.confirmed != null) ||
                  (_controllerOrderModer.orderStatus == 'handover' &&
                      (_selfDelivery ||
                          _controllerOrderModer.orderType == 'take_away'))
              : false;
          bool _showBottomView = _controllerOrderModer != null
              ? _showSlider ||
                  _controllerOrderModer.orderStatus == 'picked_up' ||
              ...
              ? Column(children: [
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          // (["cod_payment_method_name"].toString() == "1")
                                          // ?
                                          Row(
                                            children: [
                                              Text(
                                              ...
                                              Text(": ",style: robotoMedium.copyWith(
                                                  fontSize: Dimensions
                                                      .FONT_SIZE_SMALL,
                                                  color: Colors.white),),
                                              Text(
                                  ...
                                  Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                                        (_cod_payment_method_name.isEmpty)
                                            ? Container()
                                            : Text('Payment Type',
                                                style: robotoMedium.copyWith(
                                                  fontSize: Dimensions
                                  ...
                                  (_cash_pay.toString() == "0.00") ? Container() : Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        PriceConverter.convertPrice(_change_carry),
                                        style: robotoMedium.copyWith(
                                            fontSize:
                                            Dimensions.FONT_SIZE_SMALL,
                                            // color: Theme.of(context)
                  ...
                  _showBottomView
                      ? (_controllerOrderModer.orderStatus == 'picked_up')
                          ...
                          : _showSlider
                              ? (_controllerOrderModer.orderStatus ==
                                          'pending' &&
                                  ...
                                  : SliderButton(
                                      action: () {
                                        if (_controllerOrderModer.orderStatus ==
                                                'pending' &&
                                            (_controllerOrderModer.orderType ==
                                                    'take_away' ||
                                                _restConfModel ||
